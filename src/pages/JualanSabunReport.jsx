  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F7FAF9", padding: "16px", fontFamily: "'DM Sans', sans-serif",fontSize: "20px" }}>
      ...
      <div
                ...
                >
                 <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    NO
                  </span>
                   <span style={{ flex: 1, fontSize: "14px", fontWeight: 500 , color:  "#333" }}>
                    {"AHLI"}
                  </span>
                   <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    M1
            ...
            {(activeFolder.members || []).map((member, mi) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    {selectedWeek === 1 && amt > 0 ? `${amt}` : "-"}
                  </span>
                  <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    {selectedWeek === 2 && amt > 0 ? `${amt}` : "-"}
                  </span>
                  <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    {selectedWeek === 3 && amt > 0 ? `${amt}` : "-"}
                  </span>
                  <span style={{ color: "#333", fontSize: "12px", minWidth: "20px", textAlign: "right" }}>
                    {selectedWeek === 4 && amt > 0 ? `${amt}` : "-"}
                  </span>
                </div>
              );
            })}
